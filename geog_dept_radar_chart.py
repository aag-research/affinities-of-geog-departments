...
def example_data():
    ...
    data = [
        ...
        ['Cultural Ecology', 'Cultural Geography', 'Economic Development', 'Environmental Studies', 'Physical Geography', 'GIS',
         'Geomorphology', 'Remote Sensing', 'Human Geography'],
        ('University of Maryland Geography Specialization', [
            [1.0, 1, 1.0, 0, 1.00, 1.0, 0, 1.00, 1.00], #this would be specializations for each year
            [0.07, 0.95, 0.04, 0.05, 0.00, 0.02, 0.01, 0.00, 0.00], #year 2
            [0.01, 0.02, 0.85, 0.19, 0.05, 0.10, 0.00, 0.00, 0.00],
            [0.02, 0.01, 0.07, 0.01, 1, 0.12, 1, 0.00, 0.00],
